...
{
	if (region.be.af === region.bv.af)
	{
		return 'on line ' + region.be.af;
	}
	return 'on lines ' + region.be.af + ' through ' + region.bv.af;
}
...
function _VirtualDom_makeCallback(eventNode, initialHandler)
{
	function callback(event)
	{
		...
		var value = result.a;
		var message = !tag ? value : tag < 3 ? value.a : value.dc;
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { c1: 'hidden', cL: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { c1: 'mozHidden', cL: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { c1: 'msHidden', cL: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { c1: 'webkitHidden', cL: 'webkitvisibilitychange' }
		: { c1: 'hidden', cL: 'visibilitychange' };
}
...
var author$project$Model$iniMeanPosition = {ar: 0, aY: 0, ad: 0, ag: 0, a6: 0};
...
var author$project$Model$iniSettings = {bq: true, bM: 5, ca: false};
var author$project$Model$platzspitz = _Utils_Tuple2(
	'Platzspitz',
	{ar: 408.36, aY: 2683256.46, ad: 47.378631, ag: 8.541108, a6: 1248117.48});
var author$project$Model$winti = _Utils_Tuple2(
	'Winterthur',
	{ar: 475.2, aY: 2699109, ad: 47.507765, ag: 8.7542368, a6: 1262721});
...
var author$project$Model$iniModel = {
	...
	bN: author$project$Model$iniMeanPosition,
	bO: _List_Nil,
	a1: author$project$Model$iniMeasurements,
	de: elm$core$Maybe$Nothing,
	b0: 0,
	b3: author$project$Model$platzspitz,
	b8: author$project$Model$iniSettings,
	dU: elm$time$Time$utc,
	aO: 0,
	ck: 1
};
...
var author$project$Main$init = function (refLocation) {
...
var author$project$Model$Location = F8(
	function (longitude, latitude, accuracyPos, altitude, accuracyAltitude, movingSpeed, movingDegrees, timestamp) {
		return {ap: accuracyAltitude, aq: accuracyPos, ar: altitude, ad: latitude, ag: longitude, aG: movingDegrees, aH: movingSpeed, aM: timestamp};
	});
...
var author$project$Main$wgsToMyLocation = F2(
	function (model, location) {
		var φ = ((location.ad * 3600) - 169028.66) / 10000;
		var λ = ((location.ag * 3600) - 26782.5) / 10000;
		...
		return {
			ap: altiAcc,
			aq: A2(author$project$Main$runden, location.aq, 100),
			ar: alti,
			bu: A3(author$project$Main$distanceToRef, e, n, model.b3),
			aY: A2(author$project$Main$runden, e, 100),
			bA: h,
			ad: A2(author$project$Main$runden, location.ad, 1000000),
			bJ: model.b3.a,
			ag: A2(author$project$Main$runden, location.ag, 1000000),
			aG: movDegree,
			aH: movSpeed,
			a6: A2(author$project$Main$runden, n, 100),
			aM: location.aM
		};
	});
				...
				var newModel = function () {
					if (!loc.$) {
						...
						return _Utils_update(
							...
							{
								az: '',
								a1: A2(elm$core$List$cons, geoloc, model.a1),
						...
						return _Utils_update(
							model,
							{
								az: 'Fehler... ' + elm$json$Json$Decode$errorToString(fehler)
							});
					}
				}();
				var buildMyLoc = function (resultLoc) {
					return {ap: resultLoc.ap, aq: resultLoc.aq, ar: resultLoc.ar, bu: 0, aY: 0, bA: elm$core$Maybe$Nothing, ad: resultLoc.ad, bJ: '', ag: resultLoc.ag, aG: resultLoc.aG, aH: resultLoc.aH, a6: 0, aM: resultLoc.aM};
				};
			...
			default:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							aO: author$project$Geolocation$decodeWatchId(jswatchid)
						}),
					elm$core$Platform$Cmd$none);
		}
	});
...
var mdgriffith$elm_ui$Internal$Style$classes = {cl: 'a', aR: 'atv', cn: 'ab', co: 'cx', cp: 'cy', cq: 'acb', cr: 'accx', cs: 'accy', ct: 'acr', bn: 'al', bo: 'ar', cu: 'at', aS: 'ah', aT: 'av', cw: 's', cA: 'bh', cB: 'b', cD: 'w7', cF: 'bd', cG: 'bdt', as: 'bn', cH: 'bs', at: 'cpe', cM: 'cp', cN: 'cpx', cO: 'cpy', v: 'c', av: 'ctr', aw: 'cb', ax: 'ccx', w: 'ccy', ac: 'cl', ay: 'cr', cQ: 'ct', cR: 'cptr', cS: 'ctxt', cZ: 'fcs', c_: 'fs', c$: 'g', a_: 'hbh', aB: 'hc', a$: 'hf', bC: 'hfp', c2: 'hv', c4: 'ic', c6: 'fr', c8: 'iml', c9: 'it', da: 'i', U: 'nb', bQ: 'notxt', dg: 'ol', di: 'or', I: 'oq', dm: 'oh', bV: 'pg', bW: 'p', dn: 'ppe', dp: 'ui', n: 'r', dr: 'sb', ds: 'sbx', dt: 'sby', du: 'sbt', dw: 'e', dx: 'cap', dy: 'sev', dD: 'sk', l: 't', dG: 'tc', dH: 'w8', dI: 'w2', dJ: 'w9', dK: 'tj', aL: 'tja', dL: 'tl', dM: 'w3', dN: 'w5', dO: 'w4', dP: 'tr', dQ: 'w6', dR: 'w1', dS: 'tun', cd: 'ts', M: 'clr', dY: 'u', bj: 'wc', ch: 'we', bk: 'wf', ci: 'wfp', bl: 'wrp'};
var mdgriffith$elm_ui$Internal$Model$columnClass = mdgriffith$elm_ui$Internal$Style$classes.cw + (' ' + mdgriffith$elm_ui$Internal$Style$classes.v);
var mdgriffith$elm_ui$Internal$Model$gridClass = mdgriffith$elm_ui$Internal$Style$classes.cw + (' ' + mdgriffith$elm_ui$Internal$Style$classes.c$);
var mdgriffith$elm_ui$Internal$Model$pageClass = mdgriffith$elm_ui$Internal$Style$classes.cw + (' ' + mdgriffith$elm_ui$Internal$Style$classes.bV);
var mdgriffith$elm_ui$Internal$Model$paragraphClass = mdgriffith$elm_ui$Internal$Style$classes.cw + (' ' + mdgriffith$elm_ui$Internal$Style$classes.bW);
var mdgriffith$elm_ui$Internal$Model$rowClass = mdgriffith$elm_ui$Internal$Style$classes.cw + (' ' + mdgriffith$elm_ui$Internal$Style$classes.n);
var mdgriffith$elm_ui$Internal$Model$singleClass = mdgriffith$elm_ui$Internal$Style$classes.cw + (' ' + mdgriffith$elm_ui$Internal$Style$classes.dw);
	...
	switch (style.$) {
		...
		case 8:
			...
			return 'grid-rows-' + (A2(
				...
				elm$core$String$join,
				'-',
				A2(elm$core$List$map, mdgriffith$elm_ui$Internal$Model$lengthClassName, template.p)) + ('-space-x-' + (mdgriffith$elm_ui$Internal$Model$lengthClassName(template.dz.a) + ('-space-y-' + mdgriffith$elm_ui$Internal$Model$lengthClassName(template.dz.b)))))));
		case 9:
			var pos = style.a;
			return 'gp grid-pos-' + (elm$core$String$fromInt(pos.n) + ('-' + (elm$core$String$fromInt(pos.cP) + ('-' + (elm$core$String$fromInt(pos._) + ('-' + elm$core$String$fromInt(pos.bA)))))));
		case 11:
		...
		_List_fromArray(
			[
				...
				mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap(mdgriffith$elm_ui$Internal$Style$classes.c2, mdgriffith$elm_ui$Internal$Style$classes.M)) + ':hover',
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				mdgriffith$elm_ui$Internal$Style$Descriptor,
				mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap(mdgriffith$elm_ui$Internal$Style$classes.c2, mdgriffith$elm_ui$Internal$Style$classes.I)) + ':hover',
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				mdgriffith$elm_ui$Internal$Style$Descriptor,
				mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap(mdgriffith$elm_ui$Internal$Style$classes.cZ, mdgriffith$elm_ui$Internal$Style$classes.M)) + ':focus',
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				mdgriffith$elm_ui$Internal$Style$Descriptor,
				mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap(mdgriffith$elm_ui$Internal$Style$classes.cZ, mdgriffith$elm_ui$Internal$Style$classes.I)) + ':focus',
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				mdgriffith$elm_ui$Internal$Style$Descriptor,
				mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap(mdgriffith$elm_ui$Internal$Style$classes.aR, mdgriffith$elm_ui$Internal$Style$classes.M)) + ':active',
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				mdgriffith$elm_ui$Internal$Style$Descriptor,
				mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap(mdgriffith$elm_ui$Internal$Style$classes.aR, mdgriffith$elm_ui$Internal$Style$classes.I)) + ':active',
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
...
var mdgriffith$elm_ui$Internal$Style$overrides = '@media screen and (-ms-high-contrast: active), (-ms-high-contrast: none) {' + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.cw) + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.n) + (' > ' + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.cw) + (' { flex-basis: auto !important; } ' + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.cw) + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.n) + (' > ' + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.cw) + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.av) + (' { flex-basis: auto !important; }}' + (mdgriffith$elm_ui$Internal$Style$sliderOverrides + mdgriffith$elm_ui$Internal$Style$explainer))))))))))));
...
var mdgriffith$elm_ui$Internal$Style$emptyIntermediate = F2(
	function (selector, closing) {
		return {au: closing, f: _List_Nil, z: _List_Nil, s: selector};
	});
					...
					case 2:
						...
						return _Utils_update(
							rendered,
							{
								f: A2(
									elm$core$List$cons,
									{au: '\n}', f: _List_Nil, z: props, s: '@supports (' + (prop + (':' + (value + (') {' + parent.s))))},
									rendered.f)
							});
					case 4:
						var selector = rule.a;
...
var mdgriffith$elm_ui$Internal$Style$renderCompact = function (styleClasses) {
	...
	var renderClass = function (rule) {
		...
		if (!_n2.b) {
			...
			return rule.s + ('{' + (renderValues(rule.z) + (rule.au + '}')));
		}
	};
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2(
					mdgriffith$elm_ui$Internal$Model$bracket,
					'.' + (name + ('.' + (mdgriffith$elm_ui$Internal$Style$classes.dx + ('> .' + (mdgriffith$elm_ui$Internal$Style$classes.l + (', .' + (name + (' .' + (mdgriffith$elm_ui$Internal$Style$classes.dx + (' > .' + mdgriffith$elm_ui$Internal$Style$classes.l)))))))))),
					_List_fromArray(
						[
...
var mdgriffith$elm_ui$Internal$Model$adjust = F3(
	function (size, height, vertical) {
		return {bA: height / size, X: size, cf: vertical};
	});
var mdgriffith$elm_ui$Internal$Model$convertAdjustment = function (adjustment) {
	var lines = _List_fromArray(
		[adjustment.cK, adjustment.cz, adjustment.cT, adjustment.db]);
	var lineHeight = 1.5;
				...
				switch (rule.$) {
					...
					case 9:
						...
						var modernPosition = A2(
							...
							_List_fromArray(
								[
									'grid-row: ' + (elm$core$String$fromInt(position.n) + (' / ' + (elm$core$String$fromInt(position.n + position.bA) + ';'))),
									'grid-column: ' + (elm$core$String$fromInt(position.cP) + (' / ' + (elm$core$String$fromInt(position.cP + position._) + ';')))
								]));
						var _class = '.grid-pos-' + (elm$core$String$fromInt(position.n) + ('-' + (elm$core$String$fromInt(position.cP) + ('-' + (elm$core$String$fromInt(position._) + ('-' + elm$core$String$fromInt(position.bA)))))));
					...
					return A3(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$class(mdgriffith$elm_ui$Internal$Style$classes.cw + (' ' + mdgriffith$elm_ui$Internal$Style$classes.dw))
									]))
							]));
			}
		}();
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[mdgriffith$elm_ui$Internal$Style$classes.cw, mdgriffith$elm_ui$Internal$Style$classes.dw, mdgriffith$elm_ui$Internal$Style$classes.av, mdgriffith$elm_ui$Internal$Style$classes.w, mdgriffith$elm_ui$Internal$Style$classes.ct])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[mdgriffith$elm_ui$Internal$Style$classes.cw, mdgriffith$elm_ui$Internal$Style$classes.dw, mdgriffith$elm_ui$Internal$Style$classes.av, mdgriffith$elm_ui$Internal$Style$classes.w, mdgriffith$elm_ui$Internal$Style$classes.cr])))
						]),
					_List_fromArray(
						[html])) : html));
			case 1:
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[mdgriffith$elm_ui$Internal$Style$classes.cw, mdgriffith$elm_ui$Internal$Style$classes.dw, mdgriffith$elm_ui$Internal$Style$classes.av, mdgriffith$elm_ui$Internal$Style$classes.cs])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[mdgriffith$elm_ui$Internal$Style$classes.cw, mdgriffith$elm_ui$Internal$Style$classes.dw, mdgriffith$elm_ui$Internal$Style$classes.av, mdgriffith$elm_ui$Internal$Style$classes.cq])))
						]),
					_List_fromArray(
						[html])) : html));
			default:
		...
		_List_fromArray(
			[
				...
				A2(
					...
					' ',
					_List_fromArray(
						[mdgriffith$elm_ui$Internal$Style$classes.cw, mdgriffith$elm_ui$Internal$Style$classes.l, mdgriffith$elm_ui$Internal$Style$classes.bj, mdgriffith$elm_ui$Internal$Style$classes.aB])))
			]),
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				A2(
					...
					' ',
					_List_fromArray(
						[mdgriffith$elm_ui$Internal$Style$classes.cw, mdgriffith$elm_ui$Internal$Style$classes.l, mdgriffith$elm_ui$Internal$Style$classes.bk, mdgriffith$elm_ui$Internal$Style$classes.a$])))
			]),
		_List_fromArray(
			[
				...
				return mdgriffith$elm_ui$Internal$Model$Unstyled(
					A5(
						...
						mdgriffith$elm_ui$Internal$Model$Keyed(
							A3(mdgriffith$elm_ui$Internal$Model$addKeyedChildren, 'nearby-element-pls', keyed, rendered.C)),
				...
				return mdgriffith$elm_ui$Internal$Model$Unstyled(
					A5(
						...
						mdgriffith$elm_ui$Internal$Model$Unkeyed(
							A2(mdgriffith$elm_ui$Internal$Model$addChildren, unkeyed, rendered.C)),
						mdgriffith$elm_ui$Internal$Model$NoStyleSheet));
			} else {
				var allStyles = newStyles;
				return mdgriffith$elm_ui$Internal$Model$Styled(
						...
						switch (location) {
							case 0:
								return A2(
									...
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.U, mdgriffith$elm_ui$Internal$Style$classes.dw, mdgriffith$elm_ui$Internal$Style$classes.cl]));
							case 1:
								return A2(
									elm$core$String$join,
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.U, mdgriffith$elm_ui$Internal$Style$classes.dw, mdgriffith$elm_ui$Internal$Style$classes.cB]));
							case 2:
								return A2(
									elm$core$String$join,
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.U, mdgriffith$elm_ui$Internal$Style$classes.dw, mdgriffith$elm_ui$Internal$Style$classes.di]));
							case 3:
								return A2(
									elm$core$String$join,
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.U, mdgriffith$elm_ui$Internal$Style$classes.dw, mdgriffith$elm_ui$Internal$Style$classes.dg]));
							case 4:
								return A2(
									elm$core$String$join,
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.U, mdgriffith$elm_ui$Internal$Style$classes.dw, mdgriffith$elm_ui$Internal$Style$classes.c6]));
							default:
								return A2(
									elm$core$String$join,
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.U, mdgriffith$elm_ui$Internal$Style$classes.dw, mdgriffith$elm_ui$Internal$Style$classes.cA]));
						}
					}())
				]),
			_List_fromArray(
...
var mdgriffith$elm_ui$Internal$Model$alignXName = function (align) {
	switch (align) {
		case 0:
			return mdgriffith$elm_ui$Internal$Style$classes.aS + (' ' + mdgriffith$elm_ui$Internal$Style$classes.bn);
		case 2:
			return mdgriffith$elm_ui$Internal$Style$classes.aS + (' ' + mdgriffith$elm_ui$Internal$Style$classes.bo);
		default:
...
var mdgriffith$elm_ui$Internal$Model$alignYName = function (align) {
	switch (align) {
		...
		case 2:
			return mdgriffith$elm_ui$Internal$Style$classes.aT + (' ' + mdgriffith$elm_ui$Internal$Style$classes.cn);
		default:
	...
	switch (h.$) {
		...
		case 1:
			return _Utils_Tuple3(
				...
				mdgriffith$elm_ui$Internal$Style$classes.aB,
				_List_Nil);
		case 2:
			var portion = h.a;
			return (portion === 1) ? _Utils_Tuple3(
				...
				_List_fromArray(
					[
						...
						mdgriffith$elm_ui$Internal$Style$classes.cw + ('.' + (mdgriffith$elm_ui$Internal$Style$classes.n + (' > ' + mdgriffith$elm_ui$Internal$Style$dot(
...
var mdgriffith$elm_ui$Internal$Model$renderWidth = function (w) {
	switch (w.$) {
		case 0:
			...
			return _Utils_Tuple3(
				mdgriffith$elm_ui$Internal$Flag$none,
				mdgriffith$elm_ui$Internal$Style$classes.ch + (' width-px-' + elm$core$String$fromInt(px)),
				_List_fromArray(
					[
						A3(
						mdgriffith$elm_ui$Internal$Model$Single,
		...
		case 2:
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				_List_Nil) : _Utils_Tuple3(
				A2(mdgriffith$elm_ui$Internal$Flag$add, mdgriffith$elm_ui$Internal$Flag$widthFill, mdgriffith$elm_ui$Internal$Flag$none),
				mdgriffith$elm_ui$Internal$Style$classes.ci + (' width-fill-' + elm$core$String$fromInt(portion)),
				_List_fromArray(
					[
						A3(
						mdgriffith$elm_ui$Internal$Model$Single,
					...
					case 7:
						...
						if (A2(mdgriffith$elm_ui$Internal$Flag$present, mdgriffith$elm_ui$Internal$Flag$width, has)) {
							...
							switch (width.$) {
								case 0:
									var px = width.a;
									var $temp$classes = (mdgriffith$elm_ui$Internal$Style$classes.ch + (' width-px-' + elm$core$String$fromInt(px))) + (' ' + classes),
										$temp$node = node,
								...
								case 2:
									...
									if (portion === 1) {
										...
										var $temp$classes = classes + (' ' + (mdgriffith$elm_ui$Internal$Style$classes.ci + (' width-fill-' + elm$core$String$fromInt(portion)))),
											$temp$node = node,
											$temp$has = A2(
											mdgriffith$elm_ui$Internal$Flag$add,
											mdgriffith$elm_ui$Internal$Flag$widthFill,
						...
						if (A2(mdgriffith$elm_ui$Internal$Flag$present, mdgriffith$elm_ui$Internal$Flag$height, has)) {
							...
							switch (height.$) {
								case 0:
									...
									continue gatherAttrRecursive;
								case 1:
									var $temp$classes = mdgriffith$elm_ui$Internal$Style$classes.aB + (' ' + classes),
										$temp$node = node,
										$temp$has = A2(
										mdgriffith$elm_ui$Internal$Flag$add,
								...
								case 2:
									...
									if (portion === 1) {
										...
										var $temp$classes = classes + (' ' + (mdgriffith$elm_ui$Internal$Style$classes.bC + (' height-fill-' + elm$core$String$fromInt(portion)))),
											...
											A3(
												mdgriffith$elm_ui$Internal$Model$Single,
												mdgriffith$elm_ui$Internal$Style$classes.cw + ('.' + (mdgriffith$elm_ui$Internal$Style$classes.v + (' > ' + mdgriffith$elm_ui$Internal$Style$dot(
													'height-fill-' + elm$core$String$fromInt(portion))))),
												'flex-grow',
												elm$core$String$fromInt(portion * 100000)),
											styles),
...
var mdgriffith$elm_ui$Element$column = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				elm$core$List$cons,
				mdgriffith$elm_ui$Internal$Model$htmlClass(mdgriffith$elm_ui$Internal$Style$classes.cQ + (' ' + mdgriffith$elm_ui$Internal$Style$classes.ac)),
				A2(
					elm$core$List$cons,
...
var author$project$View$showAccuracy = function (model) {
	var timeString = function () {
		...
		if (!_n1.$) {
			var loc = _n1.a;
			return A2(author$project$View$toLocalTimeString, model.dU, loc.aM);
		} else {
			return '';
		}
	}();
	var accString = function () {
		...
		if (!_n0.$) {
			var loc = _n0.a;
			return elm$core$String$fromFloat(loc.aq) + ' m';
		} else {
			return '';
		}
	}();
						...
						_List_fromArray(
							[
								...
								elm$core$String$fromInt(
									elm$core$List$length(model.a1))),
								mdgriffith$elm_ui$Element$text(accString)
							]))
					]))
			]));
};
var author$project$View$secNumbers = {aV: '.', aW: 2, a4: '-', a5: '', a8: '', a9: '', bi: '\''};
var cuducos$elm_format_number$Helpers$FormattedNumber = F5(
	function (original, integers, decimals, prefix, suffix) {
		return {aW: decimals, a0: integers, bU: original, aI: prefix, aK: suffix};
	});
		...
		elm$core$String$concat(
			A2(
				...
				elm$core$List$singleton(
					A2(elm$core$Maybe$withDefault, '', formatted.aW)))));
	return onlyZeros ? 1 : ((formatted.bU < 0) ? 2 : 0);
};
...
var cuducos$elm_format_number$Helpers$parse = F2(
	function (locale, original) {
		var parts = A2(
			elm$core$String$split,
			'.',
			A2(myrho$elm_round$Round$round, locale.aW, original));
		...
		switch (_n0) {
			case 2:
				return _Utils_update(
					partial,
					{aI: locale.a4, aK: locale.a5});
			case 0:
				return _Utils_update(
					partial,
					{aI: locale.a8, aK: locale.a9});
			default:
				return partial;
		}
	});
var cuducos$elm_format_number$Helpers$stringfy = F2(
	function (locale, formatted) {
		var integers = A2(elm$core$String$join, locale.bi, formatted.a0);
		var decimals = function () {
			var _n0 = formatted.aW;
			if (!_n0.$) {
				var digits = _n0.a;
				return _Utils_ap(locale.aV, digits);
			} else {
				return '';
			}
		}();
		return elm$core$String$concat(
			_List_fromArray(
				[formatted.aI, integers, decimals, formatted.aK]));
	});
...
var author$project$View$swissNumbers = {aV: '.', aW: 2, a4: '-', a5: '', a8: '', a9: '', bi: '\''};
var author$project$View$showCoords = function (model) {
	var refPos = model.b3.b;
	var getLocNorth = function () {
		var _n3 = model.de;
		if (!_n3.$) {
			var loc = _n3.a;
			return A2(cuducos$elm_format_number$FormatNumber$format, author$project$View$swissNumbers, loc.a6);
		} else {
			return '';
		}
	}();
	var getLocLon = function () {
		...
		if (!_n2.$) {
			var loc = _n2.a;
			return author$project$View$buildDegMinSec(loc.ag);
		} else {
			return '';
		}
	}();
	var getLocLat = function () {
		...
		if (!_n1.$) {
			var loc = _n1.a;
			return author$project$View$buildDegMinSec(loc.ad);
		} else {
			return '';
		}
	}();
	var getLocEast = function () {
		...
		if (!_n0.$) {
			var loc = _n0.a;
			return A2(cuducos$elm_format_number$FormatNumber$format, author$project$View$swissNumbers, loc.aY);
		} else {
			return '';
		}
	}();
	var pos = (!model.b0) ? {
		S: getLocNorth,
		T: getLocEast,
		K: A2(cuducos$elm_format_number$FormatNumber$format, author$project$View$swissNumbers, refPos.a6),
		L: A2(cuducos$elm_format_number$FormatNumber$format, author$project$View$swissNumbers, refPos.aY)
	} : {
		S: getLocLat,
		T: getLocLon,
		K: author$project$View$buildDegMinSec(refPos.ad),
		L: author$project$View$buildDegMinSec(refPos.ag)
	};
	return A2(
		mdgriffith$elm_ui$Element$row,
		_List_fromArray(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						mdgriffith$elm_ui$Element$text('E ' + pos.L),
						mdgriffith$elm_ui$Element$text('E ' + pos.T)
					])),
				A2(
				mdgriffith$elm_ui$Element$column,
				_List_Nil,
				_List_fromArray(
					[
						mdgriffith$elm_ui$Element$text('N ' + pos.K),
						mdgriffith$elm_ui$Element$text('N ' + pos.S)
					]))
			]));
};
...
var mdgriffith$elm_ui$Element$Font$heavy = A2(mdgriffith$elm_ui$Internal$Model$Class, mdgriffith$elm_ui$Internal$Flag$fontWeight, mdgriffith$elm_ui$Internal$Style$classes.dJ);
var author$project$View$showDistanceBox = function (myLocation) {
	var getDistance = function () {
		if (!myLocation.$) {
			var loc = myLocation.a;
			return A2(cuducos$elm_format_number$FormatNumber$format, author$project$View$swissNumbers, loc.bu) + ' m';
		} else {
			return '?';
		}
	}();
...
var mdgriffith$elm_ui$Element$Font$center = A2(mdgriffith$elm_ui$Internal$Model$Class, mdgriffith$elm_ui$Internal$Flag$fontAlignment, mdgriffith$elm_ui$Internal$Style$classes.dG);
...
var author$project$View$logo = A2(
	...
	{aX: 'Logo Kt.ZH', bd: './img/loewe.png'});
var mdgriffith$elm_ui$Element$Font$extraBold = A2(mdgriffith$elm_ui$Internal$Model$Class, mdgriffith$elm_ui$Internal$Flag$fontWeight, mdgriffith$elm_ui$Internal$Style$classes.dH);
...
var author$project$View$gbParams = function (model) {
	...
	var buildPos = function (myloc) {
		return {S: myloc.a6, T: myloc.aY, K: refPos.a6, L: refPos.aY};
	};
	var pos = function () {
		var _n0 = model.de;
		if (!_n0.$) {
	...
	return 'topic=OrthoZH' + ('&scale=1000' + ('&x=' + (elm$core$String$fromFloat(pos.L) + ('&y=' + (elm$core$String$fromFloat(pos.K) + ('&srid=2056' + ('&redlining=GEOMETRYCOLLECTION(' + ('POINT(' + (elm$core$String$fromFloat(pos.L) + ('%20' + (elm$core$String$fromFloat(pos.K) + (')%2C' + ('POINT(' + (elm$core$String$fromFloat(pos.T + 4) + ('%20' + (elm$core$String$fromFloat(pos.S) + (')%2C' + ('POINT(' + (elm$core$String$fromFloat(pos.L + 4) + ('%20' + (elm$core$String$fromFloat(pos.K) + (')%2C' + ('POINT(' + (elm$core$String$fromFloat(pos.T) + ('%20' + (elm$core$String$fromFloat(pos.S) + ('))%2B%257B%22text%22%3A%257B%221%22%3A%22Standortangabe%20Navigationsger%C3%A4t%22%2C' + '%222%22%3A%22Kontrollpunkt%22%257D%257D')))))))))))))))))))))))))));
};
				...
				A2(
					...
					A2(
						...
						A2(
							...
							A2(
								elm$core$List$cons,
								mdgriffith$elm_ui$Internal$Model$htmlClass(mdgriffith$elm_ui$Internal$Style$classes.ax + (' ' + mdgriffith$elm_ui$Internal$Style$classes.w)),
								attrs))))),
			mdgriffith$elm_ui$Internal$Model$Unkeyed(
				_List_fromArray(
					[label])));
...
var author$project$View$showLinks = function (model) {
	var rowConfig2 = {aC: 'hier', bg: 'Erfahren Sie ', bh: ' mehr über den Kontrollpunkt', aN: 'https://are.zh.ch/kontrollpunkt'};
	var rowConfig1 = {
		aC: 'Kartenansicht',
		bg: '',
		bh: ' Ihres Standortes',
		aN: 'https://maps.zh.ch/?' + author$project$View$gbParams(model)
	};
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							mdgriffith$elm_ui$Element$text(cfg.bg),
							A2(
							...
							mdgriffith$elm_ui$Element$text(cfg.bh)
						]))
				]));
	};
	return A2(
...
var mdgriffith$elm_ui$Element$Font$bold = A2(mdgriffith$elm_ui$Internal$Model$Class, mdgriffith$elm_ui$Internal$Flag$fontWeight, mdgriffith$elm_ui$Internal$Style$classes.cD);
...
var mdgriffith$elm_ui$Element$Font$alignRight = A2(mdgriffith$elm_ui$Internal$Model$Class, mdgriffith$elm_ui$Internal$Flag$fontAlignment, mdgriffith$elm_ui$Internal$Style$classes.dP);
...
var author$project$View$showProjSwitch = function (proj) {
	var altImage = (proj === 1) ? {aX: 'WGS84', bd: './img/wgs84.svg'} : {aX: 'LV95', bd: './img/lv95.svg'};
	return A2(
		mdgriffith$elm_ui$Element$row,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						author$project$View$showError(model.az),
						author$project$View$showDistanceTitle,
						author$project$View$showDistanceBox(model.de),
						author$project$View$showSubtitle('Projektion'),
						author$project$View$showToggleProjection(model.b0),
...
var mdgriffith$elm_ui$Internal$Model$optionsToRecord = function (options) {
	...
	return andFinally(
		A3(
			elm$core$List$foldr,
			combine,
			{cZ: elm$core$Maybe$Nothing, c2: elm$core$Maybe$Nothing, dd: elm$core$Maybe$Nothing},
			options));
};
			...
			A2(
				...
				mdgriffith$elm_ui$Internal$Model$htmlClass(
					A2(
						...
						' ',
						_List_fromArray(
							[mdgriffith$elm_ui$Internal$Style$classes.dp, mdgriffith$elm_ui$Internal$Style$classes.cw, mdgriffith$elm_ui$Internal$Style$classes.dw]))),
...
var author$project$Main$main = elm$browser$Browser$element(
	{c7: author$project$Main$init, dF: author$project$Main$subscriptions, dZ: author$project$Main$update, d_: author$project$Main$view});
